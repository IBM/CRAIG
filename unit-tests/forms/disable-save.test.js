...
describe("disableSave", () => {
  ...
  describe("vpn_servers", () => {
    ...
    it("should return true if fields are otherwise valid with invalid port", () => {
      let actualData = disableSave(
        "vpn_servers",
        {
          name: "aaa",
    ...
    it("should return true if fields are otherwise valid with invalid crn", () => {
      let actualData = disableSave(
        "vpn_servers",
        {
          name: "aaa",
    ...
    it("should return true if fields are otherwise valid with invalid crn and method is certificate", () => {
      let actualData = disableSave(
        "vpn_servers",
        {
          name: "aaa",
