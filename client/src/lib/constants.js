...
module.exports = {
  ...
  template_dropdown_map: {
    ...
    "Power VS SAP Hana": {
      ...
      includes: [
        "A resource group for cloud services and for each VPC",
        "A management, workload, and transit VPC connected by a transit gateway",
        ...
        "All necessary networking rules to allow communication",
        "Virtual Private endpoints for Cloud Object storage in each VPC",
        "A jump-server Virtual Server instance deployment in the management VPC with a floating IP",
